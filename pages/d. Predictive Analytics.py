...
<div style='border: 2px solid #000; padding: 10px; margin:10px; background-color:#c5b4b4; text-align: center;'>
    The predictions provided by this web application are based on data and algorithms designed to offer insights and guidance. 
    While we strive to provide accurate and reliable predictions, it is important to understand that these predictions are not guaranteed 
    to be 100% accurate. The outcomes are influenced by numerous factors, some of which may be beyond the scope of our data and algorithms. 
    <br/><br/>
    Users should exercise their own judgment and discretion when relying on the predictions generated by this app. We do not assume any 
    liability for any decisions made based on the information provided by this application. For critical decisions, it is recommended 
    to consult with professionals or use additional sources of information.
 <br/><br/>     
